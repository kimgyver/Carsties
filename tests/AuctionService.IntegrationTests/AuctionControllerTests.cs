...
public class AuctionControllerTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task GetAuctionId_WithValidIdShouldReturnAuction()
    {
        // arrange
    ...
    [Fact]
    public async Task GetAuctionId_WithInvalidId_ShouldReturn404()
    {
        // arrange
    ...
    [Fact]
    public async Task GetAuctionId_WithInvalidGuid_ShouldReturn400()
    {
        // arrange
